...
𝐼 𝓌𝒶𝓈 𝓂𝒶𝒹𝑒 𝒷𝓎 @sanithbimsara ❤️</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "𝙃𝙚𝙡𝙥", callback_data="help"),
                                        InlineKeyboardButton(
                                            "𝘾𝙧𝙚𝙖𝙩𝙤𝙧", url="https://t.me/sanithbimsara")
                                    ],[
                                      InlineKeyboardButton(
                                            "➕ 𝘼𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙖 𝙂𝙧𝙤𝙪𝙥 ➕", url="http://t.me/song_dl_robot?startgroup=tr")
                                    ]]
                            ),        
...
*ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ ʙᴏᴛ ♫*</b>""",
        reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "𝙊𝙩𝙝𝙚𝙧 𝙋𝙧𝙤𝙟𝙚𝙘𝙩𝙨", url="https://t.me/c/1399318170/2"),
                                  ],[
                                        InlineKeyboardButton(
                                            "𝘽𝙖𝙘𝙠", callback_data="start")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")
...
async def send_audio(message: Message, info_dict, audio_file):
    ...
    title = '@song_dl_robot - '+s2tw(info_dict['title'])
